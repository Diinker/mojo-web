export default function StatTracking() {
  return (
      ...
      <div className="text-center">
        <div className="flex flex-row justify-center items-center gap-4">
          <svg
            ...
            className="lucide lucide-flame bg-black rounded-xl p-1"
          >
        ...
        <p className="text-xl flex flex-col items-center md:flex-row font-nature-light py-5 px-10">
          With advanced score-keeping and stat-tracking, you will never have to
          use your judgement about the score agian.
        </p>
      </div>
    </div>
  );
